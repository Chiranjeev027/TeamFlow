...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  const menuItems = [
    ...
    { id: 'analytics', text: 'Analytics', icon: <FiBarChart2 className="w-5 h-5" />, path: '/analytics' },
    { id: 'settings', text: 'Settings', icon: <FiSettings className="w-5 h-5" />, path: '/settings' },
  ];
